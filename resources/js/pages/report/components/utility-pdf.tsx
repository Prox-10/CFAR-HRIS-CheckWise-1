...
export default function UtilityPDF({ evaluation }: UtilityPDFProps) {
    // Format rating
    ...
    const sanitationOperations = ['OFFICE AREAS', 'GARDEN', 'KITCHEN AREA', 'TOILET', 'GARBAGE DISPOSAL', 'OFFICE BEAUTIFICATION'];
    const safekeepingOperations = ['OFFICE EQUIPMENT', 'SUPPLIES', 'KITCHEN UTENSILS'];
                    ...
                    <View style={styles.employeeInfo}>
                        <View style={styles.employeeInfoLeft}>
                            <View style={styles.employeeInfoRow}>
                                ...
                                <Text style={styles.employeeInfoValue}>{evaluation.department || 'UTILITY'}</Text>
                            </View>
                            <View style={styles.employeeInfoRow}>
                        ...
                        <View style={styles.employeeInfoRight}>
                            <Text style={styles.departmentLabel}>UTILITY</Text>
                        </View>
                    </View>
